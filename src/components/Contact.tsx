        ...
        <Flex justifyContent="center" alignItems="center" bgGradient="linear(to-l, #7928CA, #FF0080)" bgClip="text">
          ...
          >
            <Stack flex={1} spacing={{ base: 5, md: 10 }}>
              <Heading lineHeight={1.6} fontWeight={400} fontSize={{ base: "xl", sm: "2xl", lg: "2xl" }}>
                <Text as={"span"} color={color}>
                  ...
                  <Link
                    ...
                    size="3xl"
                    isExternal
                    href="mailto:ibukunoluwaodunsi@gmail.com "
                    _hover={{ boxShadow: "unset", color: "unset" }}
                  >
                    {" "}
                    ibukunoluwaodunsi@gmail.com <ExternalLinkIcon fontSize="3xl" mx="2px" />
                  </Link>
                </Text>
              </Heading>
            </Stack>
