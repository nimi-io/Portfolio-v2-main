            ...
            <Stack flex={1} spacing={{ base: 5, md: 10 }}>
              ...
              >
                ...
                <Text as={"span"} color={color}>
                  I'm Ibukun-Odunsi Toluwanimi
                </Text>
              </Heading>
              <Text color={color} lineHeight={1.5} fontSize={{ base: "xl" }}>
                Based in Lagos, Nigeria, I am a backend software engineer who
                specializes in developing software solutions with
                well-structured backend APIs that are interactive and visually
                appealing.
              </Text>
              <Stack
                spacing={{ base: 4, sm: 6 }}
